	...
	return (
		...
		>
			...
			<div className='absolute top-full mt-4 z-50 right-0'>
				{visible && <div className='flex  space-x-2'>
					<input
						autoFocus
						type='text'
						className='rounded bg-transparent focus:ring-0 focus:border-primary-dark dark:focus:border-primary transition dark:text-primary text-primary-dark px-2 py-1'
