...
const ConfirmModal: FC<IConfirmModal> = ({onClose,busy=false, visible, title, subTitle, onCancel, onConfirm}): JSX.Element => {
    return (
			<ModalContainer visible={visible} onClose={onClose}>
				<div className='bg-primary-dark dark:bg-primary rounded p-3 space-y-2'>
					{' '}
					{/* title */}
